...
import com.mcculloch.pokemon.model.YSortable;
...
public class Actor implements YSortable {
	...
	private float WALK_TIME_PER_TILE = 0.25f;	// seconds to spend on each tile when walking
	private float RUN_TIME_PER_TILE = 0.1f;		// seconds to spend on each tile when running
	private float BIKE_TIME_PER_TILE = 0.05f;	// seconds to spend on each tile when biking
