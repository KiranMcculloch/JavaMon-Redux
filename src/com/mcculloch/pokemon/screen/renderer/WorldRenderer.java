...
import com.mcculloch.pokemon.model.*;
...
public class WorldRenderer {
	...
	//private Pokemon testPokemon = new Pokemon("test boy",718,10,90,91,92,93,new Item(5,1),true,1);
	...
	public void render(SpriteBatch batch, Camera camera) {
		...
		//batch.draw(testPokemon.getFrontSprite(),120,120,300,300);
